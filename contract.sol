...
contract Beaver is IERC20, Ownable {
    ...
    constructor(
        ...
        minTokenAmount = (_totalSupply * 10) / 100000;

        marketing_receiver = marketingReceiver_;
        marketingFee = marketingFee_;
        developmentFee = developmentFee_;
        sellFee = sellFee_;

        IRouter _router = IRouter(0xDaE9dd3d1A52CfCe9d5F2fAC7fDe164D500E50f7);
        ...
        router = _router;
        pair = _pair;
        totalFee = marketingFee + developmentFee + sellFee;
